...
Every hyperparameter, metric and artifact is logged so any run is fully
reproducible from the MLflow UI.
"""
...
def main() -> None:
    """Load data, build the model, train and log to MLflow."""
    ...
    with mlflow.start_run(run_name="lstm-baseline") as run:
        ...
        with tempfile.NamedTemporaryFile(suffix=".joblib", delete=False) as f:
            ...
            mlflow.log_artifact(f.name, name="preprocessing")
